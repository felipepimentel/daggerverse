...
import (
	...
	"github.com/felipepimentel/daggerverse/libraries/launchdarkly/internal/dagger"
)
...
func (m *Launchdarkly) Find(ctx context.Context,
	...
	ld := &Launchdarkly{
		LaunchdarklyVersion: func() string {
			if launchdarklyVersion == "" {
				return "latest"
			}
			return launchdarklyVersion
		}(),
		Token:               token,
		Project:             project,
		Repo:                repo,
