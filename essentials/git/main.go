...
// Default ignore patterns for git status
...
// New creates a new Git instance with the given directories
func New(ctx context.Context, 
	// Optional git directory to use
	gitDir *dagger.Directory, // +optional
	// Optional working directory
	dir *dagger.Directory, // +optional
) (*Git, error) {
	// Use base container with git installed
	ctr := dag.Container().
